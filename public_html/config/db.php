...
$db   = 'p905091w_baza'; // Имя базы данных (из панели MySQL)
$user = 'p905091w_baza'; // Имя пользователя (часто совпадает с именем БД)
$pass = 'Qq12345'; // Пароль, который вы задали при создании БД
